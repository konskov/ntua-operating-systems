...
scheduler-shell2: scheduler-shell2.o proc-common.o
	$(CC) -o scheduler-shell2 scheduler-shell2.o proc-common.o
...
scheduler.o: scheduler.c proc-common.h 
...
scheduler-shell2.o: scheduler-shell2.c proc-common.h request.h
	$(CC) $(CFLAGS) -o scheduler-shell2.o -c scheduler-shell2.c
